...
GlashAgentWeb.Core.LoginPasswordManager.Instance.Init();
...
{
    GlashAgentWeb.Core.LoginPasswordManager.Instance.SetLoginPassword(adminPassword);
...
app.MapRazorComponents<GlashAgentWeb.Components.App>()
