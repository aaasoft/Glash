...
GlashServerWeb.Core.LoginPasswordManager.Instance.Init();
...
{
    GlashServerWeb.Core.LoginPasswordManager.Instance.SetLoginPassword(adminPassword);
...
app.MapRazorComponents<GlashServerWeb.Components.App>()
