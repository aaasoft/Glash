...
public class LoginPasswordManager
{
    ...
    public void Init()
    {
        LoginPassword = Glash.Blazor.Client.Model.Config.GetConfig(nameof(LoginPassword));
    ...
    {
        Glash.Blazor.Client.Model.Config.SetConfig(nameof(LoginPassword), password);
