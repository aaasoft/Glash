...
namespace Glash.Core
{
    public class GlashTunnelContext : IDisposable
    {
        ...
        private Model.TunnelInfo tunnelInfo;
        private Stream stream;
        private Action<Exception> errorHandler;

        public GlashTunnelContext(QpChannel channel, Model.TunnelInfo tunnelInfo, Stream stream, Action<Exception> errorHandler)
        {
